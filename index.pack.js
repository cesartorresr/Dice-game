...
rollBtn.addEventListener("click", function () {
    ...
    if (player1Score >= 20) {
        ...
        player1Dice.innerHTML = "<img src = \"https://i.gifer.com/7NKE.gif\"/>";
        player2Dice.innerHTML = "<img src =\"https://i.gifer.com/49f1.gif\"/>";
        showResetButton();
    } else if (player2Score >= 20) {
        message.textContent = "Player 2 Won 🎉";
        player2Dice.innerHTML = "<img src = \"https://i.gifer.com/7NKE.gif\"/>";
        player1Dice.innerHTML = "<img src =\"https://i.gifer.com/49f1.gif\"/>";
        showResetButton();
    }
